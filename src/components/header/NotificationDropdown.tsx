            ...
            <div className="flex flex-col items-center justify-center py-8 text-gray-500">
              ...
              >
                <path
                  ...
                  strokeWidth={1}
                  d="M15 17h5l-5 5v-5zM14 10h.01M14 14h.01M10 14h.01M10 10h.01M6 14h.01M6 10h.01"
                />
              </svg>
              ...
              {notifications.map((notification) => (
                <li key={notification.notification_id}>
                  <DropdownItem
                    ...
                    className={`flex gap-3 rounded-lg p-3 hover:bg-gray-100 dark:hover:bg-white/5 ${
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2 mb-1">
                        <h6 className="text-sm font-medium text-gray-800 dark:text-white/90 truncate">
                          {notification.title}
                        </h6>
                        {!notification.is_read && (
                      ...
                      {notification.issue && (
                        <div className="mt-1">
                          <span className="inline-block px-2 py-1 text-xs text-blue-600 bg-blue-100 rounded dark:bg-blue-900 dark:text-blue-300">
