...
const InfoCard: React.FC<InfoCardProps> = ({
  ...
  return (
    <div className="flex gap-5 rounded-md justify-between items-center p-4 bg-white  border border-gray-200 dark:bg-gray-800 dark:border-gray-700 w-full max-w-lg">
