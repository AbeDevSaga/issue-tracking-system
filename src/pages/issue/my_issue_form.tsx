...
export default function AddIssue() {
  ...
  const fields = [
    ...
    { id: "created_date", label: "When did issue occur?", type: "date" },
    { id: "created_time", label: "Time to Occur", type: "time" },
    ...
    { id: "issue_screenshot", label: "Document Attachement", type: "file" },
  ];
