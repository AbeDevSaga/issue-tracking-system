...
export default function TeamLeaderTask_Detail() {
  ...
  const handleFormSubmit = (values: Record<string, any>) => {
    ...
    return (
        <>
            <PageMeta
                title={t("TLTask.qa_task_detail")}
                description={t("TLTask.qa_task_detail", { title: t("TLTask.detail") })}
            />
            ...
            <div className="min-h-screen bg-[#F9FBFC] p-6 pb-24 flex flex-col items-start">
                ...
                >
                    <div
                        className={`transition-all duration-500 ease-in-out ${selectedAction ==="resolve" ? "lg:pr-[380px]" : ""
                            }`}
                    >
                                ...
                                {selectedAction === "resolve" && (
                                    <>
                                        <div className="flex justify-end gap-3">
                                            <button className="px-4 py-2 rounded-md bg-gray-200 text-gray-700 font-semibold">
                                                Cancel
                                            </button>
                                        </div>

                                        <div className="bg-white border border-[#BFD7EA] rounded-lg p-3 flex flex-col gap-4">
                                            ...
                                            <div className="w-full flex justify-end">
                                                <button className="px-4 py-2 rounded-md bg-[#1E516A] text-white font-semibold">
                                                    Confirm
                                                </button>
                                            </div>
                                        </div>
