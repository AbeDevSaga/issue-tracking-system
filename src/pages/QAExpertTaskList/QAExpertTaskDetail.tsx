...
export default function TeamLeaderTask_Detail() {
  ...
  const handleAssignSubmit = async () => {
    if (!selectedDeveloper) {
      ...
      setAlert({ type: "error", message: "Please select a Developer before submitting." });
    ...
    try {
      ...
      console.error(error);
      setAlert({ type: "error", message: "Error assigning Developer. Please try again." });
  ...
  const handleReasonSubmit = async () => {
    ...
    try {
      ...
      setAlert({ type: "success", message: "Issue Returned to Developer successfully!" });

      setShowReasonModal(false);
      setReasonNote("");
    } catch (error) {
      console.error(error);
      setAlert({ type: "error", message: "Error returning. Please try again." });
    ...
    <>
      ...
      <div className="bg-[#F9FBFC] p-4 flex flex-col lg:flex-row gap-4 pb-10">
        <div className="flex-1 bg-white rounded-xl shadow-md border border-dashed border-[#BFD7EA] p-4">
          ...
          <div className="bg-[#F1F5F9] border border-[#BFD7EA] rounded-md p-1 mb-3 text-sm">
          ...
          <div className="bg-white rounded-lg shadow-lg w-full max-w-lg p-6 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                >
                  ...
                  <option value="backend_team">Backend</option>
                  <option value="frontend_team">Frontend</option>
                  <option value="api_team">API</option>
                  <option value="devops_team">DevOps</option>
                  <option value="mobile_team">Mobile</option>
                </select>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full border border-[#BFD7EA] rounded-md p-2 text-sm focus:outline-none focus:ring-1 focus:ring-[#1E516A]"
                  disabled={!developerType} // disable until a type is selected
                >
                  <option value="">Select Developer</option>
                  {developerType &&
                    mockProjects[0][developerType as keyof Project]?.map((member) => (
            ...
            <div className="flex justify-end gap-2 mt-4">
              ...
              <button
                ...
                className={`px-4 py-1 rounded text-sm font-semibold ${isSubmitting
            ...
            <div className="grid gap-4 mb-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Reason for Returning to Developer"
                  className="w-full border border-[#BFD7EA] rounded-md p-2 text-sm focus:outline-none focus:ring-1 focus:ring-[#1E516A]"
                />
              </div>
            </div>
